...
create table Security_Question(userid varchar(20),qid1 numeric,qid2 numeric,qid3 numeric,ans1 varchar(20),ans2 varchar(20),ans3 varchar(20),foreign key(user_id) references user (user_Id), password varchar (20),qid4 numeric,qid5 numeric,qid6 numeric,ans4 varchar(20),ans5 varchar(20),ans6 varchar(20));
