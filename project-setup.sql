...
insert into ticket values('1','2022-02-08','technical error','duplicate content','use one main url','3dwin4braham');
insert into ticket values('2','2022-01-03','404 web page error','improper redirects','use webmaster tools','shashankAI');
...
create table Security_Question(user_id varchar(20),qid1 numeric,qid2 numeric,qid3 numeric,ans1 varchar(20),ans2 varchar(20),ans3 varchar(20),foreign key(user_id) references user (user_Id), password varchar (20),qid4 numeric,qid5 numeric,qid6 numeric,ans4 varchar(20),ans5 varchar(20),ans6 varchar(20));
